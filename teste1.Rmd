...
## Resumo dos Resultados
  ...
  A gestão escolar compõem grande parte do desafio da construção do ambiente educacional, diretores, vice-diretores e coordenadores são agentes imediatos neste processo. Em linhas gerais podemos definir a gestão escolar em dois grandes grupos de atividade, o primeiro deles é a gestão estrutural e operacional da escola, no qual diretores e vice-diretores exercem fundamental papel no monitoramento de questões estruturais da condição educacional e executam importante ação ao monitorar a atividade de todos os trabalhadores que compõem a unidade educacional da qual esses são responsáveis, autores como @dobbie2013getting argumentam sobre a relevância que um processo de monitoramento sobre outputs escolares tem sobre os resultados de longo prazo de uma escola; o segundo conjunto trata da gestão pessoal de todos aqueles que fazem parte do ambiente educacional, esta atividade tem importante relação com o coordenador que diante do corpo docente é responsável pelo monitoramento da estrutura e da execução do currículo escolar, além de ser importante agente na formação de professores.

...
```{r em_mat, echo=FALSE, results='asis'}
# If output: pdf_document
library(stargazer)

stargazer(linear_vdir1lp, linear_vdir2lp, linear_vdir3lp, linear_vdir4lp, se=list(robust_vdir1lp, robust_vdir2lp,robust_vdir3lp,robust_vdir4lp ),font.size = "tiny", title = "Results", type = "latex")


```


```{r decomp_em_mat, echo=FALSE, results='asis'}
# If output: pdf_document
library(kableExtra)

kable(decomp_em_mat, "latex",caption = "Ensino Médio - Matemática - Decomposição",booktabs = T) %>% 
